  ...
  return (
    ...
    <form >
      ...
      <input  type="text"  placeholder='e.g Javascript' className='w-full outline-0 border-1
       ...
       <textarea  placeholder='About Language .....' className='w-full p-2 outline-0 border-1 rounded-md border-green-500'></textarea>
       <label htmlFor="" className='font-semibold '>Type</label>
       <select  id=""  className='w-full p-1 outline-0 border-1 rounded-md border-blue-500'>
